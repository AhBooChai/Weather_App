...
var apiURL = 'https://api.openweathermap.org/data/2.5/weather?units=metric&appid=57090738bfcdb9093b1d877d7903c22f&q=';
var API_KEY = "AIzaSyBt8gibQBYoi8DtUck5HKCeUJcSa-Wzs8c";
var lat;
var lon;
...
function weatherAPI(_x) {
  return _weatherAPI.apply(this, arguments);
}
function _weatherAPI() {
  _weatherAPI = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(city) {
    var response, data, country;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 10:
          data = _context.sent;
          console.log(data);
          country = countryNames.of(data.sys.country);
          ...
          lon = data.coord.lon;
          _context.next = 25;
          return getTimeZone(lat, lon, data.name);
        case 25:
...
function getTimeZone(_x2, _x3, _x4) {
  return _getTimeZone.apply(this, arguments);
} // 
function _getTimeZone() {
  _getTimeZone = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(latitude, longitude, city) {
    var result, data, timezone, options, formatter, time;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 3;
          return fetch("https://maps.googleapis.com/maps/api/timezone/json?location=".concat(latitude, ",").concat(longitude, "&timestamp=1331161200&key=").concat(API_KEY));
        case 3:
        ...
        case 6:
          ...
          document.getElementById('dayAndTime').innerHTML = "".concat(time);
